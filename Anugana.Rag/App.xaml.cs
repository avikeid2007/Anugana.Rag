        ...
        var builder = this.CreateBuilder(args)
            ...
            .Configure(host => host
                ...
                .ConfigureServices((context, services) =>
                {
                    ...
                    services.AddSingleton<Services.ILlmService, Services.OpenRouterLlmService>();
                    services.AddSingleton<Services.ITextChunkerService, Services.TextChunkerService>();
                    services.AddSingleton<Services.IDocumentProcessorService, Services.DocumentProcessorService>();
                    services.AddSingleton<Services.IRagPipelineService, Services.RagPipelineService>();
