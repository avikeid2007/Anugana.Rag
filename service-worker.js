import { config as unoConfig } from "/package_f432a25577831bc3d88ccd6a3e9afe652aae16bc/uno-config.js";
...
if (unoConfig.environmentVariables["UNO_BOOTSTRAP_DEBUGGER_ENABLED"] !== "True") {
    ...
    self.addEventListener('install', function (e) {
        ...
        e.waitUntil(
            caches.open('8c58c64b-6aec-452c-afed-7df77f704b0a').then(async function (cache) {
            ...
            caches.keys().then(function (cacheNames) {
                return Promise.all(
                    cacheNames.filter(function (cacheName) {
                        return cacheName !== '8c58c64b-6aec-452c-afed-7df77f704b0a';
